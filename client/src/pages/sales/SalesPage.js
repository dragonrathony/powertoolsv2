...
class SalesPage extends React.Component {
    ...
    // update sales function with invoice
    updateSalesFuncWithInvoice = (data) => {
        ...
        fetch(process.env.REACT_APP_API_URL+"/sales/invoice/"+data.id, {
            method: 'PUT',
            body: formData
        })
        .then(res => res.json())
    ...
    // Update sales without invoice file
    updateSalesFunc = (data) => {
    ...
    handleUpdate = (data) => {
        ...
        // including update invoice file
        if (data.invoice) {
            this.updateSalesFuncWithInvoice(data)
        } else { // without update invoice file
            this.updateSalesFunc(data)
        }
