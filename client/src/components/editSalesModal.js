...
class EditModal extends Component {
    ...
    handleBeforeUpdate = (e) => {
        e.preventDefault();
        const { model, sn, buyer, date } = this.state;
        ...
        return (
            <Modal show={this.props.show} onHide={this.props.handleClose}>
                ...
                <Modal.Body>
                    ...
                    <p><input className="form-control" type="date" name="date" defaultValue={this.props.data.date} onChange={(e) => this.handleChange(e)} /></p>
                    {!date && <div className="help-block">Please provide sales date</div>}
